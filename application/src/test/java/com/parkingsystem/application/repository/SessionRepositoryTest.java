...
public class SessionRepositoryTest {
    ...
    void saveSessionTest() {
        ...
        SessionEntity session = saveNewSession(user, updateInterval, tariff, licensePlateNumber);
        ...
        assertEquals(updateInterval, session.getUpdateInterval());
    ...
    void findSessionByLicensePlateNumberTest() {
        SessionEntity session = saveNewSession(createNewUser(), updateInterval, tariff, licensePlateNumber);
    ...
    private SessionEntity saveNewSession(UserEntity user, Integer updateInterval, BigDecimal tariff, String licensePlateNumber) {
